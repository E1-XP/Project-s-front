enum global {
  ...
  GLOBAL_AUTHORIZATION_ERROR = 'GLOBAL_AUTHORIZATION_ERROR',
}
...
enum canvas {
  ...
  CANVAS_INCR_DRAWING_VERSION = 'CANVAS_INCR_DRAWING_VERSION',
  ...
  CANVAS_REDRAW_BACK = 'CANVAS_REDRAW_BACK',
  ...
  CANVAS_SET_CURRENT_THUMBNAIL = 'CANVAS_SET_CURRENT_THUMBNAIL',
}
...
enum socket {
  ...
  SOCKET_RECONNECT_IN_ROOM = 'SOCKET_RECONNECT_IN_ROOM',
  ...
  SOCKET_EMIT_ROOM_DRAW_RECONNECT = 'SOCKET_EMIT_ROOM_DRAW_RECONNECT',
