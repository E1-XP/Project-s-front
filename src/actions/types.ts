...
enum canvas {
  ...
  CANVAS_SET_NEW_DRAWING_POINTS_GROUP = 'CANVAS_SET_NEW_DRAWING_POINTS_GROUP',
  CANVAS_SET_NEW_BROADCASTED_DRAWING_POINTS_GROUP = 'CANVAS_SET_NEW_BROADCASTED_DRAWING_POINTS_GROUP',
  CANVAS_INIT_CLEAR_DRAWING_POINTS = 'CANVAS_INIT_CLEAR_DRAWING_POINTS',
  CANVAS_CLEAR_DRAWING_POINTS = 'CANVAS_CLEAR_DRAWING_POINTS',
  CANVAS_INIT_DRAWING_BROADCAST = 'CANVAS_INIT_DRAWING_BROADCAST',
  CANVAS_INIT_MOUSE_UP_BROADCAST = 'CANVAS_INIT_MOUSE_UP_BROADCAST',
  CANVAS_SET_DRAW_COUNT = 'CANVAS_SET_DRAW_COUNT',
