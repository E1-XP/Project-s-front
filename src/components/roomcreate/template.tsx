...
export const RoomCreateComponent: ComponentType<Props> = ({
    handleSubmit, state, setName, currentDrawing,
    setPassword, setIsPrivate, goToNextStage, handleDrawingCreate, handleDrawingSelect
}) => {
    ...
    switch (state.formStage) {
        ...
        case 2: return (<ImageSelector currentDrawing={currentDrawing} handleDrawingCreate={handleDrawingCreate}
